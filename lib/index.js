...
var keyboardJS = __webpack_require__(9);
var MIDI = __webpack_require__(1);
var Vue = __webpack_require__(6);
var utils_1 = __webpack_require__(15);
exports.DELAY = 0;
exports.VELOCITY = 127;
exports.CHANNEL = 0;
exports.AUTO_CLICK_BASE = true;
exports.LEFT_HAND_VELOCITY = exports.VELOCITY / 5;
exports.MIDDLE_C_NOTE = 60;
exports.NOTE_MODE = true;
window.app = new Vue({
    el: '#app',
    data: {
        currentChord: [],
...
function playNote(note, velocity) {
    if (velocity === void 0) { velocity = exports.VELOCITY; }
    console.log(note);
    if (Array.isArray(note)) {
        // play chord
        app.currentChord = note;
        MIDI.chordOn(exports.CHANNEL, note, velocity, exports.DELAY);
        if (exports.AUTO_CLICK_BASE) {
            MIDI.noteOn(exports.CHANNEL, note[0] - 2 * 12, exports.LEFT_HAND_VELOCITY, exports.DELAY);
            app.currentNote = note[0] - 2 * 12;
        }
    }
    else {
        app.currentNote = note;
        MIDI.noteOn(exports.CHANNEL, note, velocity, exports.DELAY);
    }
}
function onsuccess() {
    var C = utils_1.calChord(['C', 'E', 'G']);
    var Dm = utils_1.calChord(['D', 'F', 'A']);
    var Am = utils_1.calChord(['A', '+C', '+E']);
    var Em = utils_1.calChord(['E', 'G', 'B']);
    var F = utils_1.calChord(['F', 'A', '+C']);
    var G = utils_1.calChord(['G', 'B', '+D']);
    var Am7 = utils_1.calChord(['A', 'C', 'E', 'G']);
    keyboardJS.bind('c', function () {
        // play C major chord - origin inversion
        playNote(C['0']);
    }, function () {
    });
    keyboardJS.bind('c + ctrl', function () {
        // play C major chord - first inversion
        playNote(C['1']);
    });
    keyboardJS.bind('c + shift', function () {
        // play C major chord - second inversion
        playNote(C['2']);
    });
    keyboardJS.bind('c + space', function () {
        playNote(C['-2']);
    });
    keyboardJS.bind('a', function () {
        playNote(Am['0']);
    });
    keyboardJS.bind('a + ctrl', function () {
        playNote(Am['1']);
    });
    keyboardJS.bind('a + shift', function () {
        playNote(Am['2']);
    });
    keyboardJS.bind('a + space', function () {
        playNote(Am['-2']);
    });
    keyboardJS.bind('a + 7', function () {
        playNote(Am7['0']);
    });
    keyboardJS.bind('a + 7 + shift', function () {
        playNote(Am7['-1']);
    });
    keyboardJS.bind('d', function () {
        playNote(Dm['0']);
    });
    keyboardJS.bind('d + ctrl', function () {
        playNote(Dm['1']);
    });
    keyboardJS.bind('d + shift', function () {
        playNote(Dm['2']);
    });
    keyboardJS.bind('d + space', function () {
        playNote(Dm['-2']);
    });
    keyboardJS.bind('e', function () {
        playNote(Em['0']);
    });
    keyboardJS.bind('e + ctrl', function () {
        playNote(Em['1']);
    });
    keyboardJS.bind('e + shift', function () {
        playNote(Em['2']);
    });
    keyboardJS.bind('e + space', function () {
        playNote(Em['-2']);
    });
    keyboardJS.bind('f', function () {
        playNote(F['0']);
    });
    keyboardJS.bind('f + ctrl', function () {
        playNote(F['1']);
    });
    keyboardJS.bind('f + shif', function () {
        playNote(F['2']);
    });
    keyboardJS.bind('f + space', function () {
        playNote(F['-2']);
    });
    keyboardJS.bind('g', function () {
        playNote(G['0']);
    });
    keyboardJS.bind('g + ctrl', function () {
        playNote(G['1']);
    });
    keyboardJS.bind('g + shift', function () {
        playNote(G['2']);
    });
    keyboardJS.bind('g + space', function () {
        playNote(G['-2']);
    });
    // borken chord
    keyboardJS.bind('y', function () {
        playNote(utils_1.calBrokenChord()[1]);
    });
    keyboardJS.bind('u', function () {
        playNote(utils_1.calBrokenChord()[1]);
    });
    keyboardJS.bind('i', function () {
        playNote(utils_1.calBrokenChord()[2]);
    });
    keyboardJS.bind('o', function () {
        playNote(utils_1.calBrokenChord()[3]);
    });
    keyboardJS.bind('p', function () {
        playNote(utils_1.calBrokenChord()[5]);
    });
    keyboardJS.bind('h', function () {
        playNote(utils_1.calBrokenChord()[8]);
    });
    keyboardJS.bind('j', function () {
        playNote(utils_1.calBrokenChord()[10]);
    });
    var _loop_1 = function (i) {
        keyboardJS.bind("" + i, function () {
            switch (i) {
                case 1:
                    playNote(exports.MIDDLE_C_NOTE);
                    break;
                case 3:
                case 4:
                    playNote(exports.MIDDLE_C_NOTE + i + 1);
                    break;
                case 5:
                    playNote(exports.MIDDLE_C_NOTE + i + 2);
                    break;
                case 6:
                    playNote(exports.MIDDLE_C_NOTE + i + 3);
                    break;
                case 7:
                    playNote(exports.MIDDLE_C_NOTE + i + 4);
                    break;
                case 8:
                    playNote(exports.MIDDLE_C_NOTE + i + 4);
                    break;
                case 9:
                    playNote(exports.MIDDLE_C_NOTE + i + 5);
                    break;
                default:
                    playNote(exports.MIDDLE_C_NOTE + i);
            }
        });
        keyboardJS.bind('0', function () {
            playNote(exports.MIDDLE_C_NOTE + 16);
        });
        keyboardJS.bind('-', function () {
            playNote(exports.MIDDLE_C_NOTE + 17);
        });
        keyboardJS.bind('=', function () {
            playNote(exports.MIDDLE_C_NOTE + 19);
        });
    };
    // bind 1-9
    for (var i = 1; i < 13; i++) {
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js??ref--1-2!./style.css", function() {
			var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js??ref--1-2!./style.css");
...
keyboard.setLocale('us', __webpack_require__(11));
...
var keyBinding_1 = __webpack_require__(4);
MIDI.loadPlugin({
    instrument: 'acoustic_grand_piano',
    soundfontUrl: '/static/soundfont/',
    onsuccess: keyBinding_1.onsuccess
});
...
function isAddedNote(noteName) {
    return startsWith(noteName, '+');
}
exports.isAddedNote = isAddedNote;
// calculate note map depends on base C note ID
function calNoteMap(baseCNote) {
    if (baseCNote === void 0) { baseCNote = exports.C1_NOTE_ID + 12 * (exports.OCTAVE - 1); }
    var ret = {};
    Object.keys(exports.noteMap).forEach(function (note) {
        ret[note] = baseCNote + exports.noteMap[note];
    });
    return ret;
}
exports.calNoteMap = calNoteMap;
function calChord(noteNames) {
    var baseCNote = exports.C1_NOTE_ID + 12 * (exports.OCTAVE - 1);
    var addedBaseCNote = baseCNote + 12;
    var addAddedBaseCNote = addedBaseCNote + 12;
    var subedBaseC = baseCNote - 12;
    var generatedNoteMap = calNoteMap(baseCNote);
    var generatedAddNoteMap = calNoteMap(addedBaseCNote);
    var generatedSubNoteMap = calNoteMap(subedBaseC);
    var generatedAddAddNoteMap = calNoteMap(addAddedBaseCNote);
    var ORIGIN_NOTE_0 = generatedNoteMap[noteNames[0].replace('+', '')];
    var ORIGIN_NOTE_1 = generatedNoteMap[noteNames[1].replace('+', '')];
    var ORIGIN_NOTE_2 = generatedNoteMap[noteNames[2].replace('+', '')];
    var ADDED_NOTE_0 = generatedAddNoteMap[noteNames[0].replace('+', '')];
    var ADDED_NOTE_1 = generatedAddNoteMap[noteNames[1].replace('+', '')];
    var ADD_ADDED_NOTE_1 = generatedAddAddNoteMap[noteNames[1].replace('+', '')];
    var ADDED_NOTE_2 = generatedAddNoteMap[noteNames[2].replace('+', '')];
    var ADD_ADDED_NOTE_2 = generatedAddAddNoteMap[noteNames[2].replace('+', '')];
    var SUB_NOTE_0 = generatedSubNoteMap[noteNames[0].replace('+', '')];
    var SUB_NOTE_1 = generatedSubNoteMap[noteNames[1].replace('+', '')];
    var SUB_NOTE_2 = generatedSubNoteMap[noteNames[2].replace('+', '')];
    if (noteNames.length === 3) {
        ...
        // Seventh chords
        var ORIGIN_NOTE_3 = generatedNoteMap[noteNames[3].replace('+', '')];
        var SUB_NOTE_3 = generatedSubNoteMap[noteNames[3].replace('+', '')];
        return {
...
exports.calChord = calChord;
// calculate broken chord
function calBrokenChord(notes) {
    if (notes === void 0) { notes = window.app.currentChord; }
    var baseNote = notes[0];
    var threeNote = notes[1];
    var fiveNote = notes[2];
    var brokenBaseNote = baseNote - 2 * 12 + 1;
    var broken = [];
...
exports.calBrokenChord = calBrokenChord;
